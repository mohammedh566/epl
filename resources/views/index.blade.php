...
<head>
	...
	<title>Ettikulam Premier League</title>
...
<body>
	...
	<div class="loading" id="wrapper">
			...
			<div class="slide text-slider-wrapper">
				<div class="container">
					<ul class="text-slider clearfix">
						<li class="clearfix">
							<span class="lead">Ettikulam Premier League</span>
						</li>
					</ul>
				</div>
			</div>
			<a href="#teams" class="go-to godown">
				<span>
		...
		<section class="portfolio" id="portfolio">
			...
			<div class="container">
				<div class="heading">
					<h1>Do you like our page?</h1>
					<p>For personalized pages for teams or other projects contact me.</p>
				</div>
						...
						<div class="row">
							<div class="col-md-3">
								<div class="number-item">
									<span class="number" id="clientsCounter" data-count="10" data-duration="3">1600</span>
									<span class="text">Matches Played</span>
								</div>
							</div>
							<div class="col-md-3">
								<div class="number-item">
									<span class="number" id="projectCounter" data-count="100" data-duration="10">3200</span>
									<span class="text">Total Goals Scored</span>
								</div>
							</div>
							<div class="col-md-3">
								<div class="number-item">
				...
				<div class="masked">
					<div class="container">
						<div id="testimonials" class="bxslider clearfix">
							...
							<blockquote>
								<p>I am constantly being asked about individuals. The only way to win is as a team. Football is not about one or two or three star players.</p>
								<div class="divider">
									<span></span>
								</div>
								Pele
							...
							<blockquote>
								<p>A football team is like a beautiful woman. When you do not tell her, she forgets she is beautiful.</p>
								<div class="divider">
									<span></span>
								</div>
								Arsène Wenger
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 adress-element delay2">
						...
						<h3>Our mail</h3>
						<span class="font-l">mohammedh566@gmail.com</span>
					</div>
					<div class="col-md-4 adress-element delay4">
						<i class="fa fa-phone fa-2x"></i>
						<h3>Our phone</h3>
						<span class="font-l">+91-9790822088</span>
					</div>
				</div>
			</div>
